...
PROGRAM incompact3d
  ...
  ! CALL track_front(ux1, rho1, ta1, tb1, di1, ta2, ta3, 0.1)
  ! CALL track_front(ux1, rho1, ta1, tb1, di1, ta2, ta3, 0.5)
  ! CALL track_front(ux1, rho1, ta1, tb1, di1, ta2, ta3, 0.9)
  ! CALL track_front(ux1, rho1, ta1, tb1, di1, ta2, ta3, -1.0)
  ! CALL track_front_height(rho1, ta1, di1, rho2, ta2, rho3, ta3)
...
1001  format('Time step =',i7,', Time unit =',F9.3)
    ...
    do itr=1,iadvance_time
      ...
      if (.not.iadj_mode) then
         ...
         call convdiff_adj(ux1,uy1,uz1,rho1,mu1,uxb1,uyb1,uzb1,ta1,tb1,tc1,td1,&
